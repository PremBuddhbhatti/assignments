let op1, op2, opr, perform, flag = true, dot = true, performFlg = true, DOMdisp = document.getElementById("ans"), DOMwhlStr = document.getElementById("whlStr"), DOMselTrigo = document.getElementById("selTrigo").getElementsByTagName("option")[0];
...
function btnPower10() {
    ...
    DOMdisp.innerHTML = Math.pow(10, parseFloat(parseFloat(DOMdisp.innerHTML).toFixed(2))).toString();
}
